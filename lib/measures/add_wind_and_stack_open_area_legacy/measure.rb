class AddWindAndStackOpenAreaLegacy < OpenStudio::Measure::EnergyPlusMeasure

  # define the name that a user will see
  def name
    return "Add Wind and Stack Open Area Legacy"
  end
...
AddWindAndStackOpenAreaLegacy.new.registerWithApplication