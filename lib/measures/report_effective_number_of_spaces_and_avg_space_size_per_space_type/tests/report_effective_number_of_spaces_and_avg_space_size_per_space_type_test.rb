...
class ReportEffectiveNumberOfSpacesAndAvgSpaceSizePerSpaceType_Test < MiniTest::Unit::TestCase
  ...
  def test_number_of_arguments_and_argument_names
    ...
    measure = ReportEffectiveNumberOfSpacesAndAvgSpaceSizePerSpaceType.new
